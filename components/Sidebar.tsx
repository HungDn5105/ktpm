...
interface SidebarProps {
  activeTab: 'dashboard' | 'fees';
  onTabChange: (tab: 'dashboard' | 'fees') => void;
}
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col hidden md:flex">
      ...
      <nav className="flex-1 p-4 space-y-2 mt-4">
        ...
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-all duration-200">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
